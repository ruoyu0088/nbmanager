...
def process_code(code):
    ...
    for line in code.split(u"\n"):
        if line.startswith((u"#%fig", u"#%nofig", u"%%disabled", "%C ", "%%include")):
            continue
...
class Worker(object):
    ...
    def process_input(self, cell):
        ...
        return process_code(cell.source)
